...
<body>
 <div class="container-fluid">
	    ...
	    <div id="main-content" class="content-wrapper col-md-10 content-area p-3">
           ...
           <a href="#" class="songArt" data-song-id="10"><img src="http://localhost:8080/playlist2/image/metacity.jpg" width="100" height="100" style="border: 1px solid black"></a>
           <a href="#" class="songArt" data-song-id="11"><img src="http://localhost:8080/playlist2/image/metacity.jpg" width="100" height="100" style="border: 1px solid black"></a>
	    </div>	
	    </div>	
        </div>
